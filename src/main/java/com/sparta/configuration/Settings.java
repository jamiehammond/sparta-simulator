...
public enum Settings {
    ...
    NEW_TRAINEE_TRAINING_TIME_IN_MONTHS("new_trainee_training_time_in_months",12),
    ...
    CLIENT_FIRST_CLIENT_AFTER_FIRST_MONTHS("client_first_client_after_first_months", 12),
